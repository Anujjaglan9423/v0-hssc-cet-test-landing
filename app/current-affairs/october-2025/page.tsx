...
export default function OctoberCurrentAffairsPage() {
    ...
    const newsItems: NewsItem[] = [
        ...
        },
        {
            ...
            impactHi: [
                ...
                "'तटस्थ' रुख में बद��ाव वैश्विक परिस्थितियों के स्थिर रहने पर 2026 की शुरुआत में दरों में कटौती का संकेत देता है"
            ],
            staticGk: [
        ...
        },
        {
            ...
            titleHi: "नोबेल पुरस्कार 2025: AI, क्वांटम बायोलॉजी ���र mRNA में सफलताएँ",
            category: "science",
            ...
            staticGk: [
                { fact: "Nobel Prize Establishment", description: "Established by Alfred Nobel's will in 1895; first awarded in 1901", factHi: "नोबेल पुरस्कार स्थापना", descriptionHi: "1895 में अल्फ्रेड नोबेल की वसीयत द्वारा स्थापि��; पहली बार 1901 में प्रदान किया गया" },
    ...
    const faqs = [
        ...
        { q: "What is Unified Lending Interface (ULI)?", qHi: "यूनिफाइड लेंडिंग इंटरफेस (ULI) क्या है?", a: "ULI is a digital platform launched by RBI to digitize loan appraisal for small farmers and MSMEs by integrating data from state governments, credit bureaus, and satellite agencies.", aHi: "ULI RBI द्वारा शुरू किया गया एक डिजिटल प्लेटफॉर्म है जो राज्य सरकारों, क्रेडिट ब्यूरो और उपग्रह एजेंसियों के डे��ा को एकीकृत करके छोटे किसानों और MSMEs के लिए ऋण मूल्यांकन को डिजिटल करता है।" },
            ...
            <section className="py-8 px-4 bg-muted/30 border-t">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <p className="text-xs text-muted-foreground mt-3">
                        {language === "en" ? "Source: CET TEST editorial team • Research Grade Analysis • For Educational Purposes" : "स्रोत: CET TEST editorial team • अनुसंधान-ग्रेड विश्लेषण • शैक्षिक उद्देश्यों के लि��"}
                    </p>
                </div>
            </section>
