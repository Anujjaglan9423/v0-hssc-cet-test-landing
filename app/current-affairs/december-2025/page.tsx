...
export default function DecemberCurrentAffairsPage() {
    ...
    const newsItems: NewsItem[] = [
        ...
        },
        {
            ...
            summaryHi: "COP30 12 दिसंबर, 2025 को ब्राजील के बेलेम में संपन्न हुआ, जिसमें 'मिशन 1.5°C', वैश्विक जलवा��ु वित्त लक्ष्य और 25 बिलियन डॉलर के संकल्प के साथ 'बेलेम घोषणा' की स्थापना पर ध्यान केंद्रित किया गया।",
            ...
            staticGk: [
                ...
                { fact: "Paris Agreement", description: "Adopted at COP21 (2015) to limit warming to below 2°C", factHi: "पेरिस समझौता", descriptionHi: "COP21 (2015) में तापमान वृद्धि को 2°C से कम स��मित करने के लिए अपनाया गया" },
