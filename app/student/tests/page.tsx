...
import { Loader2, ChevronRight, BookOpen, GraduationCap, Train, Mountain, AlertCircle } from "lucide-react"
...
const defaultCategories = [
  {
    ...
    name: "Haryana Exams",
    slug: "haryana",
    description: "All Haryana state government competitive exams including CET, Police, Group D, and more",
    exams: [],
  },
  {
    id: "ssc",
  ...
  },
  {
    ...
    name: "Railway Exams",
    slug: "railway",
    description: "Indian Railways recruitment exams including RRB NTPC, Group D, ALP, and more",
    exams: [],
  },
  {
    id: "uttarakhand",
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center max-w-2xl mx-auto">
        <h1 className="text-3xl lg:text-4xl font-bold text-foreground mb-3">Choose Your Exam Category</h1>
        <p className="text-muted-foreground">
          Select an exam category to explore available tests and start your preparation journey
        </p>
      </div>
        ...
        {categories.map((category) => (
          <Link key={category.id} href={`/student/tests/${category.slug}`}>
            <Card className="group cursor-pointer overflow-hidden border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
              ...
              <div
                className={`relative h-40 bg-gradient-to-br ${categoryColors[category.slug] || "from-gray-500 to-gray-700"}`}
              >
