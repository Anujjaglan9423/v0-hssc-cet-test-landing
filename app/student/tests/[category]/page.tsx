...
import { Loader2, ChevronRight, ChevronLeft, FileText, BookOpen, Target, GraduationCap } from "lucide-react"
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div>
        ...
        <h1 className="text-3xl lg:text-4xl font-bold text-foreground mb-2">{category.name}</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {exams.map((exam) => {
          ...
          return (
            <Link key={exam.id} href={`/student/tests/${categorySlug}/${exam.id}`}>
