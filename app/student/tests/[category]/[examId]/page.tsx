    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl lg:text-3xl font-bold text-foreground">{examName || "Exam Tests"}</h1>
            <p className="text-muted-foreground mt-1">{tests.length} tests available</p>
          </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        <Card className="bg-primary/10 border-primary/20">
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-foreground">{fullTests.length}</p>
        ...
        <Card className="bg-green-500/10 border-green-500/20">
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-foreground">{subjectTests.length}</p>
        ...
        <Card className="bg-amber-500/10 border-amber-500/20">
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-foreground">{topicTests.length}</p>
      ...
      <Tabs defaultValue="full" className="space-y-6">
        ...
        <TabsContent value="full">
          {filterBySearch(fullTests).length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-lg font-semibold text-foreground mb-2">No Full Exam Tests</h3>
              <p className="text-muted-foreground">No full exam tests available for this exam.</p>
            </div>
          )}
        </TabsContent>
        ...
        <TabsContent value="subject">
          ...
          {filteredSubjectTests.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-lg font-semibold text-foreground mb-2">No Subject Tests</h3>
              <p className="text-muted-foreground">No subject-wise tests available for this exam.</p>
            </div>
          )}
        </TabsContent>
        ...
        <TabsContent value="topic">
          {uniqueTopics.length > 0 && (
            <FilterButtons items={uniqueTopics} selected={selectedTopic} onSelect={setSelectedTopic} label="Topic" />
          )}
          {filteredTopicTests.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-lg font-semibold text-foreground mb-2">No Topic Tests</h3>
              <p className="text-muted-foreground">No topic-wise tests available for this exam.</p>
            </div>
          )}
        </TabsContent>
      </Tabs>
