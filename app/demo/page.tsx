      ...
      <section className="pt-24 pb-16 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">Experience Our Demo Tests</h1>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Take a free demo test to experience our platform. Choose from three popular Haryana government exam
              patterns.
            </p>
          </div>
                ...
                >
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div className="flex items-start gap-4">
                      <div className={`w-14 h-14 rounded-xl ${test.bgColor} flex items-center justify-center`}>
                        <Icon className={`w-7 h-7 ${test.textColor}`} />
                      </div>
                      <div className="flex-1">
                        <h3 className="text-xl font-bold text-foreground mb-1">{test.title}</h3>
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {test.topics.map((topic) => (
                        <span key={topic} className="px-2 py-1 bg-muted rounded-full text-xs text-muted-foreground">
                          {topic}
                        </span>
                      ))}
                    </div>
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-6">
            <div className="flex items-start gap-4 p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Try our demo tests without creating an account</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-4">
              <div className="w-10 h-10 rounded-full bg-accent/10 flex items-center justify-center flex-shrink-0">
