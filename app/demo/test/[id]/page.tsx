...
export default function DemoTestPage() {
  ...
  const handleSubmit = () => {
    ...
    let wrong = 0
    let unanswered = 0
    const questionResults: Record<string, { selected: string | null; correct: string; isCorrect: boolean }> = {}
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-4">The demo test you are looking for does not exist.</p>
          <Button onClick={() => router.push("/demo")}>Back to Demo Tests</Button>
        </div>
      </div>
    )
  }
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="max-w-2xl w-full p-8 space-y-6">
          ...
          <div className="flex gap-4">
            <Button variant="outline" className="flex-1 bg-transparent" onClick={() => router.push("/demo")}>
              Go Back
            </Button>
      ...
      <header className="sticky top-0 z-50 bg-card border-b border-border px-2 lg:px-4 py-2 lg:py-3">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            <Button variant="destructive" size="sm" onClick={() => setShowSubmitDialog(true)} disabled={isSubmitting}>
              Submit
            </Button>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto p-2 lg:p-4 grid grid-cols-1 lg:grid-cols-4 gap-4 lg:gap-6">
        ...
        <div className="lg:col-span-3 space-y-4 lg:space-y-6">
          ...
          <Card className="p-4 lg:p-6">
            ...
            <p className="text-base lg:text-lg text-foreground mb-6 leading-relaxed">{question.question_text}</p>
            ...
            >
              {[
                ...
                >
                  ...
                  <span className="font-medium text-muted-foreground uppercase mr-2">{option.key}.</span>
                  <span className="text-foreground text-sm lg:text-base">{option.value}</span>
                </Label>
              ))}
            </RadioGroup>
          </Card>
