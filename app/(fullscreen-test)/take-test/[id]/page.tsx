...
export default function FullscreenTestPage() {
  ...
  const enterFullscreenOnStart = async () => {
    try {
      if (!document.fullscreenElement) {
        await document.documentElement.requestFullscreen()
      }
  ...
  const handleResumeFromPaused = async () => {
    if (pausedState && test) {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <Button onClick={handleGoBack}>Back to Tests</Button>
        </div>
      </div>
    )
  }
        ...
        <Card className="max-w-2xl w-full p-8 space-y-6">
          ...
          <div className="space-y-3 bg-muted/30 rounded-lg p-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li className="flex items-start gap-2">
                ...
                <span className="font-medium text-foreground">Test will open in fullscreen mode for distraction-free experience</span>
              </li>
            </ul>
          </div>
          ...
          {!pausedState && (
            <div className="flex gap-4">
              <Button variant="outline" className="flex-1 bg-transparent" onClick={handleGoBack}>
                Go Back
              </Button>
          ...
          {pausedState && (
            <Button variant="outline" className="w-full bg-transparent" onClick={handleGoBack}>
              Go Back
            </Button>
          )}
        </Card>
