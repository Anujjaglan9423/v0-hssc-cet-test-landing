...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const examKeywords = alerts.flatMap((alert) => alert.title.split(/[:|–-]/).map((part) => part.trim())).filter((part) => part.length > 3).slice(0, 80)
  return {
    ...
    keywords: [...new Set([...baseKeywords, ...examKeywords])],
