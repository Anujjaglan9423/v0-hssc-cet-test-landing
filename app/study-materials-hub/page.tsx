...
const studySections = [
  {
    number: "01",
    title: "Syllabus",
    description: "Explore the complete Haryana government exam syllabus, subjects, weightage, and preparation direction.",
    href: "/syllabus",
    icon: FileText,
  ...
  },
  {
    ...
    description: "Keep your preparation sharp with relevant monthly updates for Haryana government exams.",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="overflow-hidden px-4 pb-20 pt-28 sm:px-6 lg:px-8">
        <section className="relative mx-auto max-w-6xl overflow-hidden rounded-[2rem] border border-slate-800 bg-slate-950 px-6 py-12 text-white shadow-2xl shadow-slate-950/20 sm:px-10 sm:py-16 lg:px-16 lg:py-20">
          ...
          <div className="relative grid items-end gap-10 lg:grid-cols-[1fr_auto]">
            <div className="max-w-3xl">
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-amber-300/30 bg-amber-300/10 px-3.5 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-amber-200">
                ...
                Haryana government exam preparation
              </div>
              ...
              <p className="mt-6 max-w-2xl text-base leading-8 text-slate-300 sm:text-lg">
                One place for the essential resources you need to prepare with clarity, consistency, and confidence for Haryana government exams.
              </p>
            </div>
