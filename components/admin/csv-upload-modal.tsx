...
"2","What is 2+2?","(a) 3 (b) 4 (c) 5 (d) 6","Sample","Ans. (b)","Basic addition"`
  ...
  const handleAddExam = async () => {
    ...
    try {
      const result = await createExam(newExamName.trim(), selectedCategoryId || undefined)
          ...
          {step === "upload" && (
            <div className="space-y-4">
              ...
              >
                ...
                <Button type="button" variant="outline" onClick={handleFileInputClick} disabled={isProcessing}>
                  Browse Files
                </Button>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select value={testType} onValueChange={(v: "exam" | "subject" | "topic") => setTestType(v)}>
                    <SelectTrigger className="mt-1">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
              ...
              <div className="flex justify-between pt-4">
                ...
                <Button onClick={() => setStep("preview")} disabled={!testTitle || !selectedCategoryId}>
                  Preview Questions
          ...
          {step === "preview" && (
            <div className="space-y-4">
                ...
                {paginatedQuestions.map((q, idx) => (
                  <div key={q.id} className="p-4 border rounded-lg bg-card">
                    ...
                    <div className="grid grid-cols-2 gap-1 text-xs">
                      ...
                      <span className={cn("p-1 rounded", q.correctAnswer === "b" && "bg-accent/20 text-accent")}>
                        B: {q.optionB}
                      </span>
                      <span className={cn("p-1 rounded", q.correctAnswer === "c" && "bg-accent/20 text-accent")}>
                        C: {q.optionC}
                      </span>
                      <span className={cn("p-1 rounded", q.correctAnswer === "d" && "bg-accent/20 text-accent")}>
                        D: {q.optionD}
                      </span>
                    </div>
                  </div>
              ...
              <div className="flex justify-between pt-4">
                ...
                <Button onClick={handleCreateTest} disabled={isCreating || questions.length === 0}>
                  {isCreating ? (
                    <>
