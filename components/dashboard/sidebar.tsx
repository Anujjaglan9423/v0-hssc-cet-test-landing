    ...
    <>
      ...
      <div className="p-4 border-t border-border">
        <button
          ...
          className={cn(
            "cursor-pointer flex items-center gap-3 px-3 py-2.5 rounded-lg w-full text-muted-foreground hover:bg-destructive/10 hover:text-destructive transition-colors",
            collapsed && !isMobile && "justify-center px-2",
          )}
        >
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 h-16 bg-card border-b border-border flex items-center justify-between px-4">
        ...
        <Button variant="ghost" size="icon" onClick={() => setMobileOpen(true)} className="cursor-pointer">
      ...
      >
        <Button variant="ghost" size="icon" className="absolute top-4 right-4 cursor-pointer" onClick={() => setMobileOpen(false)}>
          <X className="w-5 h-5" />
        </Button>
      ...
      >
        ...
        <Button
          variant="ghost"
          size="icon"
          className="cursor-pointer absolute -right-3 top-20 w-6 h-6 rounded-full border border-border bg-background shadow-sm"
